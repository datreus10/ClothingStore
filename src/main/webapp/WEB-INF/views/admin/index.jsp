...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/assets/vendors/iconly/bold.css"/>">

    <link rel="stylesheet" href="<c:url value="/resources/assets/vendors/perfect-scrollbar/perfect-scrollbar.css"/>">
    <link rel="stylesheet" href="<c:url value="/resources/assets/vendors/bootstrap-icons/bootstrap-icons.css"/>">
...
<body>
    <div id="app">
        <c:import url="layout/adminSideBar.jsp">
