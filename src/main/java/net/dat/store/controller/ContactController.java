...
import net.dat.store.model.Contact;
...
public class ContactController {
	...
	public ModelAndView get() {
		...
		return new ModelAndView("admin/add_contact" , "contactForm", contactForm);
	}
	...
	public ModelAndView save(@ModelAttribute("contactForm") ContactForm contactForm) {
		...
		return new ModelAndView("admin/show_contact", "contactForm", contactForm);
	}
}